...
# Report findings
print('The less data you are training on, the more prone to overfitting you are.')
print('We can see this by the Lower MSE on the training data resulting in a High MSE on the test data.')
print('As more data is used, the training MSE goes up, but the MSE of the test data goes down.')
print('Leading the the model being more useful in terms of generalizing various data inputs.')
